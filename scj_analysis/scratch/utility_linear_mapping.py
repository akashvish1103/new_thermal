...
# This file in indside SCRATCH folder in "scj_analysis" root folder.
...
def get_first_last_element_from_OnePixelColumn_AND_min_max_from_filename(lst, path):
    ...
    file name sholud be : "01_HDRS_Thermal_25_40"
    where 25 is the minimum temp and 40 is the maximum temperature
    """
...
def driver_get_temperature(video_path, pixel_value):
    ...
    return temperature                                        # returning the Temperature in Degree Celcius